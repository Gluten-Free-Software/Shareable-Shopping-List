...
public class ListItems extends Fragment {
    ...
    public void getListItemsMethod(){
        ...
        try {
            ...
            }).execute(new URL("http://158.38.193.197:8080/Shareable-Shopping-List-REST/api/lists/getListItems?listItemList="+list+"&listItemOwner="+username));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public void deleteList(View v, String listName, String listOwner){
        RequestQueue queue = Volley.newRequestQueue(v.getContext());
        String url = "http://158.38.193.197:8080/Shareable-Shopping-List-REST/api/lists/removeList2?listName=" + listName + "&listOwner=" + listOwner;
    ...
    public void addListItem(View v, String listItemList, String listItemName, String listItemOwner) {
        RequestQueue queue = Volley.newRequestQueue(v.getContext());
        String url = "http://158.38.193.197:8080/Shareable-Shopping-List-REST/api/lists/addListItem?listItemList=" + listItemList + "&listItemName=" + listItemName + "&listItemOwner=" + listItemOwner;
        // Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
